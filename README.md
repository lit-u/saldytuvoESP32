...
1. **Veido atpažinimas** (`face_recognition.cpp`) — šiuo metu grąžina tik `PERSON_UNKNOWN`. Kitas žingsnis: `esp-who`/ESP-DL biblioteka su OV5640 kadrais.
...
6. ~~Kodas dar nesukompiliuotas realiai~~ — **PATIKRINTA**: `pio run` praeina švariai (SUCCESS, 0 warning/error). RAM 34.5% (112900/327680 B), Flash 17.1% (1121713/6553600 B) — po radaro/PCF8574 pašalinimo. Žr. "Build ir rasta klaida" žemiau.
